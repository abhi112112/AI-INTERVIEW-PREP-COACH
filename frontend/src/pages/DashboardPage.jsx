...
import { PlusCircle, BookOpen, ChevronRight, TrendingUp, Code2, Users, FileText, CheckCircle2, Award, Compass } from 'lucide-react';
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      ...
      <div className="glass-panel p-8 rounded-3xl border border-slate-800 relative overflow-hidden flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
        <div className="space-y-2 max-w-2xl">
          ...
          <h1 className="text-3xl font-extrabold text-white tracking-tight">
            Welcome back, <span className="bg-clip-text text-transparent bg-gradient-to-r from-teal-300 to-indigo-300">{user?.name}</span> 👋
          </h1>
          <p className="text-slate-300 text-sm leading-relaxed">
            Ready for your next session? Select a category or paste a target job description to practice 5 questions with structured STAR feedback.
          </p>
        </div>

        <Link
          to="/interview/setup"
          className="px-6 py-3.5 rounded-xl bg-gradient-to-r from-teal-600 to-indigo-600 hover:from-teal-500 hover:to-indigo-500 text-white font-bold shadow-lg shadow-teal-900/20 flex items-center space-x-2 transition-all hover:scale-105 shrink-0"
        >
      ...
      <div className="space-y-4">
        <h2 className="text-xl font-bold text-white tracking-tight flex items-center space-x-2">
          <span>Choose Practice Focus</span>
        </h2>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <div
            onClick={() => navigate('/interview/setup?cat=Behavioral')}
            className="glass-card p-6 rounded-2xl border border-slate-800 cursor-pointer hover:border-teal-500/40 group transition-all"
          >
            ...
            <h3 className="font-bold text-white text-base group-hover:text-teal-300 transition-colors">Behavioral</h3>
          ...
          >
            ...
            <h3 className="font-bold text-white text-base group-hover:text-indigo-300 transition-colors">Technical / DSA</h3>
            <p className="text-slate-400 text-xs mt-1 leading-relaxed">
          ...
          >
            ...
            <h3 className="font-bold text-white text-base group-hover:text-emerald-300 transition-colors">Project Walkthrough</h3>
            <p className="text-slate-400 text-xs mt-1 leading-relaxed">
          ...
          >
            ...
            <h3 className="font-bold text-white text-base group-hover:text-purple-300 transition-colors">Custom Job Description</h3>
            <p className="text-slate-400 text-xs mt-1 leading-relaxed">
      ...
      <div className="space-y-4 pt-4">
        <div className="flex items-center justify-between">
          ...
          <Link to="/history" className="text-xs font-semibold text-teal-400 hover:text-teal-300 flex items-center space-x-1">
